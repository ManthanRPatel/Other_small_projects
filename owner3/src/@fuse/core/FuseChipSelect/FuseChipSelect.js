...
function FuseChipSelect(props) {
	...
	const changeInputValue = (event) => {
		// console.log('changeInputValue :',event)
	...
	return props.variant === 'standard' ? (
		// return props.variant === 'fixed' ? (
		<Select classNamePrefix="fuse-chip-select" {...props} components={components} onChange={handleOnChange} onInputChange={changeInputValue} />
	) : (
			// <Creatable classNamePrefix="fuse-chip-select" {...props} components={components} onChange={handleOnChange} />
			<Creatable classNamePrefix="fuse-chip-select"
				createOptionPosition="first"
				formatCreateLabel={(inputValue) => `+ Create "${inputValue}"`}
				{...props} components={components} onChange={handleOnChange} />
		);
}
